# AI Context & Instructions for ha-foodsharing

## 🧬 Project DNA
**Repository:** `ha-foodsharing`
**Type:** Home Assistant Custom Integration
**Domain:** `foodsharing`
**Description:** A comprehensive Home Assistant custom integration for Foodsharing.de — monitor nearby food baskets, fairteiler locations, pickup schedules, messages, and notifications directly from your smart home dashboard. This integration utilizes the official Foodsharing.de API.
...
### 🚀 Google Antigravity
- **Codebase Navigation:** Begin by analyzing `custom_components/foodsharing/`. Search for established patterns in `api.py` or `coordinator.py` before modifying entities.
